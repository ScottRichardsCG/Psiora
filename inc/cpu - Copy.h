...
private:
    ...
    void tst8(BYTE *val);
    void clr8(BYTE *val);
    void and8(BYTE *val, BYTE val2);
    void or8(BYTE *val, BYTE val2);
    void eor8(BYTE *val, BYTE val2);
    void sub8(BYTE *val, BYTE val2);
    void sbc8(BYTE *val, BYTE val2);
    void bit8(BYTE *val, BYTE val2);
    void ld8(BYTE *val, BYTE val2);
    void adc8(BYTE *val, BYTE val2);
    void add8(BYTE *val, BYTE val2);
    void st8(BYTE *val, ADDRESS addr);
    void cmp8(BYTE *val, BYTE val2);

    void neg16(WORD_16 *val);
    void com16(WORD_16 *val);
    void lsr16(WORD_16 *val);
    void ror16(WORD_16 *val);
    void asr16(WORD_16 *val);
    void asl16(WORD_16 *val);
    void rol16(WORD_16 *val);
    void dec16(WORD_16 *val);
    void inc16(WORD_16 *val);
    void tst16(WORD_16 *val);
    void clr16(WORD_16 *val);
    void sub16(WORD_16 *val, WORD_16 val2);
    void ld16(WORD_16 *val, WORD_16 val2);
    void cmp16(WORD_16 *val, WORD_16 val2);
    void st16(WORD_16 *val, ADDRESS addr);
    void add16(WORD_16 *val, WORD_16 val2);
...
#define DO_IN_MEMORY8(cmd, addr) {BYTE t = memory->read(addr); cmd(&t); }
#define DO_IN_MEMORY8_2(cmd, addr, val) {BYTE t = memory->read(addr); cmd(&t, val); }
#define DO_ON_MEMORY8(cmd, addr) {BYTE t = memory->read(addr); cmd(&t); memory->write(addr, t); }
#define DO_ON_MEMORY8_2(cmd, addr, val) {BYTE t = memory->read(addr); cmd(&t, val); memory->write(addr, t); }

#define DO_IN_MEMORY16(cmd, addr) {WORD_16 t = memory->read(addr); cmd(&t); }
#define DO_IN_MEMORY16_2(cmd, addr, val) {WORD_16 t = memory->read(addr); cmd(&t, val); }
#define DO_ON_MEMORY16(cmd, addr) {WORD_16 t = memory->read(addr); cmd(&t); memory->write(addr, t); }
#define DO_ON_MEMORY16_2(cmd, addr, val) {WORD_16 t = memory->read(addr); cmd(&t, val); memory->write(addr, t); }
